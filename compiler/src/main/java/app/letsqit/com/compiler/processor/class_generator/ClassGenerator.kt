...
import app.letsqit.com.compiler.processor.consts.packageName
import app.letsqit.com.compiler.processor.consts.primitives
import app.letsqit.com.compiler.processor.extentions.changeCharCase
import app.letsqit.com.compiler.processor.extentions.toTitle
...
/**
 * Created by gilgoldzweig on 16/07/2017.
 */
...
//                .addMethod()
    ...
    fun addFunction(function: FunctionConfigurationFile): ClassGenerator {
        val simpleName = function.field.fieldClass.simpleName()
...
//                            emptyList(), ClassName.bestGuess(classQualifiedName))).build()
    ...
    private fun createProperty(variableName: String, variableClass: String, variableDefaultValue: String?):
        ...
        val propertyClass = (if (isPropertyNull) "$variableClass?" else variableClass).asTypeName()
